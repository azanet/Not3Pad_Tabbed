...
public class PanelMenuBar extends JPanel {
   ...
   public JMenu archivo,edicion,imprimir,mode,ayuda,personalizar;
    ...
    public JMenuItem modo1,modo2,modo3,modo4,modo5,modo6,modo7;
  ...
  //  super(new GridLayout(1, 1)); 
    ...
    private void Iniciar(){
     ...
     //   panelPrincipal= new JPanel();
        ...
        this.modo1 = new JMenuItem ("MODE1");
        this.modo2 = new JMenuItem ("MODE2");
        this.modo3 = new JMenuItem ("MODE3");
        this.modo4 = new JMenuItem ("MODE4");
        this.modo5 = new JMenuItem ("MODE5");
        this.modo6 = new JMenuItem ("MODE6");
        this.modo7 = new JMenuItem ("MODE7");
